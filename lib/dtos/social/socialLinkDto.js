...
exports.SocialLinkDto = void 0;
const ducktyper_1 = require("ducktyper");
const isSocialLinkState_1 = require("../../va/social/isSocialLinkState");
const isUserLink_1 = require("../../va/user/isUserLink");
class SocialLinkDto extends ducktyper_1.DuckDto {
}
__decorate([
    (0, ducktyper_1.duckorate)(isUserLink_1.isUserLink, {
        message: "not a valid activator",
    }),
    __metadata("design:type", Array)
], SocialLinkDto.prototype, "users", void 0);
__decorate([
    (0, ducktyper_1.duckorate)(isSocialLinkState_1.isSocialLinkState, {
        message: "not a valid social state"
    }),
    __metadata("design:type", Array)
], SocialLinkDto.prototype, "history", void 0);
